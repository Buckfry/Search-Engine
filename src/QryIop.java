...
public abstract class QryIop extends Qry {
	 ...
	 * and locIterator iterate over the cached inverted list, NOT recursively
	 * over the query arguments.
	 */
	...
	/**
	 * Advance the query operator's internal iterator to the specified document
	 * if it exists, or beyond if it doesn't.
	 * 
	 * @param docid
	 *            The document's internal document id
	 */
	 ...
	 * points to now. Use docIteratorHasMatch to determine whether the iterator
	...
	/**
	 * Return the postings for the document that the docIterator points to now,
	 * or throw an error if the docIterator doesn't point at a document.
	 * 
	 ...
	 * operator. It is an error to call this method before the object's
	...
	/**
	 * Get the document frequency (df) associated with this query operator. It
	 * is an error to call this method before the object's initialize method is
	 * called.
	 * 
	...
	/**
	 * Advance the query operator's internal iterator beyond any possible
	 * location.
	 */
	...
	/**
	 * Returns true if the query operator's internal iterator currently points
	 * to a location.
	 * 
	...
	/**
	 * get term frequency of invertedlist, override the function in Qry
	 * 
