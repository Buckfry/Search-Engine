...
public class QryParser {
	...
	private static Qry createOperator(String operatorName) {
		...
		if (operatorNameLowerCase.length()>=7&&operatorNameLowerCase.substring(0, 7).equals("#window")) {
			operatorDistance = Integer.parseInt(operatorNameLowerCase.substring(8).trim());
			operator = new QryIopWindow(operatorDistance);
		}
		else if (operatorNameLowerCase.length()>=5&&operatorNameLowerCase.substring(0, 5).equals("#near")) {
			operatorDistance = Integer.parseInt(operatorNameLowerCase.substring(6).trim());
